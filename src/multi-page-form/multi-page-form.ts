        ...
        return html`
          <div class="space-y-6 h-[30rem]">
            ...
            <div>
              ...
              <div class="mt-2">
                <input id="fullName" name="fullName" type="text" autocomplete="current-fullName"
                       class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
              </div>
            </div>
          </div>`;
        ...
        return html`
          <div class="space-y-6 h-[30rem]">
            <div class="col-span-full">
              <label for="street-addressline-one" class="block text-sm font-medium leading-6 text-gray-900">Street
            ...
            <div class="col-span-full">
              <label for="street-addressline-two" class="block text-sm font-medium leading-6 text-gray-900">Street
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2">
                <select id="country" name="country" autocomplete="country-name" class="finput">
            ...
            <fieldset>
              ...
              <div class="mt-4 divide-y divide-gray-200 border-b border-t border-gray-200">
                ...
                <div class="relative flex items-start py-4">
                  ...
                  <div class="ml-3 flex h-6 items-center">
                    <input id="side-1" name="plan" type="radio"
                           class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"/>
                  </div>
                </div>
                <div class="relative flex items-start py-4">
                  ...
                  <div class="ml-3 flex h-6 items-center">
                    <input id="side-2" name="plan" type="radio"
                           class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"/>
                  </div>
                </div>
                <div class="relative flex items-start py-4">
                  ...
                  <div class="ml-3 flex h-6 items-center">
                    <input id="side-3" name="plan" type="radio"
                           class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"/>
                  </div>
                </div>
                <div class="relative flex items-start py-4">
                  ...
                  <div class="ml-3 flex h-6 items-center">
                    <input id="side-4" name="plan" type="radio"
                           class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"/>
                  </div>
                </div>
                <div class="relative flex items-start py-4">
                  ...
                  <div class="ml-3 flex h-6 items-center">
                    <input id="side-5" name="plan" type="radio"
                           class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"/>
                  </div>
                </div>
              </div>
